...
class ECGTransformer(nn.Module):
    def __init__(self, num_classes = 71):
        ...
        filter_sizes = [5, 9, 11]
        self.conv1 = nn.Conv1d(in_channels = 12, out_channels = 32, kernel_size = filter_sizes[0],
                               stride = 1, bias = False, padding = (filter_sizes[0] // 2))
        self.conv2 = nn.Conv1d(in_channels = 12, out_channels = 32, kernel_size = filter_sizes[1],
                               stride = 1, bias = False, padding = (filter_sizes[1] // 2))
        self.conv3 = nn.Conv1d(in_channels = 12, out_channels = 32, kernel_size = filter_sizes[2], 
        ...
        self.conv_block2 = nn.Sequential(
            nn.Conv1d(in_channels = 32, out_channels = 32 * 2, kernel_size = 7, stride = 1, bias = False, padding = 4),
        ...
        self.conv_block3 = nn.Sequential(
            nn.Conv1d(in_channels = 32 * 2, out_channels = 128, kernel_size = 7, stride = 1, bias = False, padding = 4),
        ...
        self.clf = nn.Linear(128, self.num_classes)
